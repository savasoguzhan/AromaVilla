...
namespace ApplicationCore.Services
{
    public class BasketService : IBasketServices
    {
        ...
        {
            var specBasket = new BasketWithItemSpecifications(buyerId);
        ...
        public async Task<Basket> SetQuantites(string buyerId, Dictionary<int, int> quantities)
        {
            var basket = await GetOrCreateBasketAsync(buyerId);
        ...
        {
            var specSourceBasket = new BasketWithItemSpecifications(sourceBuyerId);
